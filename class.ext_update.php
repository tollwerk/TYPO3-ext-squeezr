...
class ext_update
{
    ...
    function main()
    {
        ...
        $squeezrConfig = implode("\n", array(
            ...
            "define('SQUEEZR_ROOT', '".\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('squeezr',
        ...
        file_put_contents(PATH_site.'typo3temp'.DIRECTORY_SEPARATOR.'squeezr'.DIRECTORY_SEPARATOR.'config.php',
            '<?php'."\n\n$squeezrConfig");
        copy(\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('squeezr',
            'Resources'.DIRECTORY_SEPARATOR.'Private'.DIRECTORY_SEPARATOR.'Php'.DIRECTORY_SEPARATOR.'squeezr.php'),
            PATH_site.'typo3temp'.DIRECTORY_SEPARATOR.'squeezr'.DIRECTORY_SEPARATOR.'index.php');
        ...
        if (!@is_file(PATH_site.'typo3temp'.DIRECTORY_SEPARATOR.'squeezr'.DIRECTORY_SEPARATOR.'.htaccess')) {
            $htaccess = file_get_contents(\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('squeezr',
            ...
            file_put_contents(PATH_site.'typo3temp'.DIRECTORY_SEPARATOR.'squeezr'.DIRECTORY_SEPARATOR.'.htaccess',
                str_replace('RewriteBase /squeezr', 'RewriteBase /typo3temp/squeezr', $htaccess));
        }
